                ...
                <ul>        
                    <li class='li'>
                        ...
                        <ul class='mm-collapse'>
                            <li>
                                <a href='index' class="hyperlink_to_move">
                                    <i class='fas fa-file-invoice'></i>
                                    <span> الطلبات </span>
                                </a>
                            </li>
                            <li>
                                <a href='del/index' class="hyperlink_to_move">
                    ...
                    <li class='li'>
                        ...
                        <ul class='mm-collapse'>
                            <li>
                                <a href='index_appointed'  class="hyperlink_to_move">
                                    <i class='fa-solid fa-id-card-clip'></i>
                                    <span> المعينيين  </span>
                                </a>
                            </li>
                            <li>
                                <a href='del/index_appointed'  class="hyperlink_to_move">
                                    <i class="fa-solid fa-trash"></i>
                                    <span> المحذوفات </span>
                                </a>
                            </li>
                    ...
                    <li class='li'>
                        ...
                        <ul class='mm-collapse'>
                            <li>
                                <a href='index_postpone'  class="hyperlink_to_move">
                                    <i class='fa-solid fa-info'></i>
                                    <span> المؤجلين  </span>
                                </a>
                            </li>
                            <li>
                                <a href='del/index_postpone'  class="hyperlink_to_move">
                                    <i class="fa-solid fa-trash"></i>
                                    <span> المحذوفات  </span>
                                </a>
                            </li>
                    ...
                    <li class='settings'>
                        <a href='settings'  class="hyperlink_to_move">
            ...
            <div class='show-board'>
                ...
                <div class="input-group is-invalid">
                    <form method="post" class="d-flex w-100">
                        ...
                        <button type="submit" name="search" class="btn btn-success my-2"> بحث </button>
                    </form>
                </div>
                <div class='data-info'>
                    <table class='table table-bordered table-striped' id='table'>
                        ...
                        <tbody id='body-data'>
                            <?php
                                ...
                                $database = new PDO("mysql:host=localhost;dbname=roaya_form_cv", "root", "");
                                if(isset($_POST['search'])){
                                    echo "
                                        <script>
                                            let searchInput = document.querySelector('#searchInput');
                                            searchInput.value = '$_POST[searchInput]';
                                            search_items.value = '$_POST[search_items]';
                                        </script>
                                    ";
                                
                                    if($_POST['search_items'] === 'name'){
                                        $SEARCH = $database->prepare("SELECT * FROM employee_postpone WHERE CONCAT(first_name, ' ', second_name, ' ', third_name, ' ', last_name) LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
                                                ...
                                                <td>
                                                    <div class='dropdown'>
                                                        ...
                                                        <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                            <form action='show/show_postpone?employid=$employ[employ_id]' type='submit' method='post'>
                                        ...
                                        $SEARCH = $database->prepare("SELECT * FROM employee_postpone WHERE dateOfdate LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
                                    ...
                                    }elseif($_POST['search_items'] == 'governorate'){
                                        $SEARCH = $database->prepare("SELECT * FROM employee_postpone WHERE governorate LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class='dropdown'>
                                                        ...
                                                        <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                            <form action='show/show_postpone_postpone?employid=$employ[employ_id]' type='submit' method='post'>
                                                                <input type='hidden' id='id' name='id' value='$row[employ_id]'>
                                                                <button class='btn btn-primary w-100 my-1'>
                                                                    عــرض
                                                                </button>
