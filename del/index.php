                            ...
                            <?php
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    if($_POST['search_items'] === 'name'){
                                        ...
                                        $SEARCH = $database->prepare("SELECT * FROM delete_specific WHERE CONCAT(first_name, ' ', second_name, ' ', third_name, ' ', last_name) LIKE :value");
                                                    ...
                                                    <div class='dropdown'>
                                                        ...
                                                        <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                            ...
                                                            <form action='../php/appointed?employid=$employ[employ_id]' type='submit' method='post'>
                                                                <input type='hidden' id='id' name='id' value='$row[employ_id]'>
                                                                <input type='hidden' id='typedatabase' name='typedatabase' value='delete_specific'>
                                        ...
                                        $SEARCH = $database->prepare("SELECT * FROM delete_specific WHERE date_Of_date LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
                                        ...
                                        $SEARCH = $database->prepare("SELECT * FROM delete_specific WHERE governorate LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
