                                    ...
                                    if($_POST['search_items'] === 'name'){
                                        ...
                                        foreach($SEARCH AS $row){
                                            echo"
                                                    ...
                                                    <td>
                                                        <div class='dropdown'>
                                                            ...
                                                            <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                                ...
                                                                <button type='button' class='btn btn-danger w-100 my-1' data-toggle='modal' data-tarPOST='#exampleModal'>
                                                                    حذف
                                                                </button>
                                                            </div>
                                                        </div>
                                                ...
                                                <form action='acc_del.php?userid=$employ[employ_id]' method='post'>
