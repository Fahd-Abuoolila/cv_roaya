...
<html lang='ar'>
    ...
    <body>
        ...
        <?php
            ...
            $ID = $_POST['id'];
            $select = mysqli_query($conection, "SELECT * FROM delete_specific WHERE employ_id=$ID");
                ...
                <ul>        
                    <li class='li'>
                        ...
                        <ul class='mm-collapse'>
                            <li>
                                <a href='../../index.php?employid=<?php echo $employ['employ_id']?>'>
                                    <i class='fas fa-file-invoice'></i>
                                    <span> الطلبات </span>
                                </a>
                            </li>
                            <li>
                                <a href='../../del/index.php?employid=<?php echo $employ['employ_id']?>'>
                    ...
                    <li class='li'>
                        ...
                        <ul class='mm-collapse'>
                            <li>
                                <a href='../../index_appointed.php?employid=<?php echo $employ['employ_id']?>' class=''>
                                    <i class='fa-solid fa-id-card-clip'></i>
                                    <span> المعينيين  </span>
                                </a>
                            </li>
                            <li>
                                <a href='../../del/index_appointed.php?employid=<?php echo $employ['employ_id']?>'>
                                    <i class="fa-solid fa-trash"></i>
                                    <span> المحذوفات </span>
                                </a>
                            </li>
                    ...
                    <li class='li'>
                        ...
                        <ul class='mm-collapse'>
                            <li>
                                <a href='../../index_postpone.php?employid=<?php echo $employ['employ_id']?>'>
                                    <i class='fa-solid fa-info'></i>
                                    <span> المؤجلين  </span>
                                </a>
                            </li>
                            <li>
                                <a href='../../del/index_postpone.php?employid=<?php echo $employ['employ_id']?>'>
                                    <i class="fa-solid fa-trash"></i>
                                    <span> المحذوفات  </span>
                                </a>
                            </li>
                    ...
                    <li class='settings'>
                        <a href='../../settings.php?employid=<?php echo $employ['employ_id']?>&mood=create'>
                            <i class='fa fa-cog'></i>
                            <span>الاعدادات</span>
                        </a>
                    </li>
