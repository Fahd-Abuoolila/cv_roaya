                            ...
                            <?php
                                ...
                                if(isset($_POST['search'])){
                                    ...
                                    if($_POST['search_items'] === 'name'){
                                        $SEARCH = $database->prepare("SELECT * FROM employee_appointed WHERE CONCAT(first_name, ' ', second_name, ' ', third_name, ' ', last_name) LIKE :value");
                                                ...
                                                <td>
                                                    <div class='dropdown'>
                                                        ...
                                                        <div class='dropdown-menu' style='position: absolute; transform: translate3d(2px, 35px, 0px); top: 0px; left: 0px; will-change: transform;' x-placement='bottom-start'>
                                                            <form action='show/show_appointed?employid=$employ[employ_id]' type='submit' method='post'>
                                        ...
                                        $SEARCH = $database->prepare("SELECT * FROM employee_appointed WHERE dateOfdate LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
                                        ...
                                        $SEARCH = $database->prepare("SELECT * FROM employee_appointed WHERE governorate LIKE :value");
                                        $SEARCH_VALUE = "%" .$_POST['searchInput']."%";
                                        $SEARCH->bindParam("value", $SEARCH_VALUE, PDO::PARAM_STR);
                                        $SEARCH->execute();
                                        $i = 1;
